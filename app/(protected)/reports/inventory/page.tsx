        ...
        <div className="text-card-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="border rounded-md p-6">
              ...
              <p className="text-muted-foreground mt-1">No inventory data available</p>
            </div>
            <div className="border rounded-md p-6">
              <h3 className="text-lg font-medium mb-2">Low Stock Items</h3>
              <p className="text-3xl font-bold">0</p>
              <p className="text-muted-foreground mt-1">No items below reorder point</p>
            </div>
          </div>
          <div className="border rounded-md p-8 text-center">
            <h3 className="text-lg font-medium mb-2">No inventory data available</h3>
            <p className="text-muted-foreground mb-4">Add products and stock entries to generate reports.</p>
          </div>
        </div>
      </div>
    </div>
